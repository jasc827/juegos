...
//comprobar modo arrastrar o clickear
function cModo(){
...
function ultMov(){
    ...
    if(ids!=""){
        ...
        if(ultFich=="nada_"){
            ...
            $("#c"+fild+""+cold).append($("#"+ids));
            $("#d"+fils+""+cols).attr("id","d"+fild+""+cold);
        }else{          
            ...
            if(ff.charAt(4)=="b"){
                ...
                var list=$("#dddbl"+compbl);
                var parentDiv = list.parentNode;
                parentDiv.remove(list);
                compbl--;
...
function turnos(){
    ...
    $("#turno").html("Jugador "+n+" ("+localStorage.getItem("turno")+")");  
}
...
//Rellenar el tablero con fichas
function rell(){
    for(var fil=1;fil!=9;fil++){
        for(var col=1;col!=9;col++){
...
function creaFich(fil,col,rell){
    ...
    if(fil<5){      
        ...
        if(fil==2){                 
            dd.innerHTML=".";
            dd.setAttribute("style", "background-image: url(../img/chess-icons/peon-n.svg);");
            if(rell==true){
                array[fil][col]="peonn";
            }
        }
        if(fil==1){
            ...
            if(col==1 || col==8){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/torre-n.svg);");
                if(rell==true){
                    array[fil][col]="torrn";
                }
            }
            ...
            if(col==2 || col==7){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/caballo-n.svg);");
                if(rell==true){
                    array[fil][col]="caban";
                }
            }
            ...
            if(col==3 || col==6){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/alfil-n.svg);");                     
                if(rell==true){
                    array[fil][col]="alfin";
                }
            }
            ...
            if(col==4){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/reina-n.svg);");
                if(rell==true){
                    array[fil][col]="reinn";
                }                       
            }
            ...
            if(col==5){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/rey-n.svg);");
                if(rell==true){
                    array[fil][col]="rey_n";
                }
            }
        ...
        if(fil==7){                 
            dd.innerHTML=".";
            dd.setAttribute("style", "background-image: url(../img/chess-icons/peon-b.svg);");
            if(rell==true){
                array[fil][col]="peonb";
            }
        }
        if(fil==8){
            ...
            if(col==1 || col==8){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/torre-b.svg);");
                if(rell==true){
                    array[fil][col]="torrb";
                }
            }
            ...
            if(col==2 || col==7){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/caballo-b.svg);");
                if(rell==true){
                    array[fil][col]="cabab";
                }
            }
            ...
            if(col==3 || col==6){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/alfil-b.svg);");
                if(rell==true){
                    array[fil][col]="alfib";
                }
            }
            ...
            if(col==4){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/reina-b.svg);");
                if(rell==true){
                    array[fil][col]="reinb";
                }                   
            }
            ...
            if(col==5){
                dd.innerHTML=".";
                dd.setAttribute("style", "background-image: url(../img/chess-icons/rey-b.svg);");
                if(rell==true){
                    array[fil][col]="rey_b";
                }
            }
    ...
    if(permi!="no"){
        ...
        if(ficha=="peonb"){
            ...
            if(array[filcam][colcam]!="nada"){
                if(filcam>0 && colcam>0 && filcam<9 && colcam < 9 ){
                    if(array[filcam][colcam].charAt(4)=="n"){
                        if(jaqueMate==false){
                            $("#c"+filcam+""+colcam).removeClass().addClass("cmover");
                        }else{
            ...
            if(array[filcam][colcam1]!="nada"){
                if(filcam>0 && colcam1>0 && filcam<9 && colcam1 < 9 ){
                    if(array[filcam][colcam1].charAt(4)=="n"){
                        if(jaqueMate==false){
                            $("#c"+filcam+""+colcam1).removeClass().addClass("cmover");
                        }else{
            ...
            if(fil==7 && array[filcam][col].charAt(4)!="b" && array[filcam-1][col]!="b"){
                $("#c"+filcam+""+col).removeClass().addClass("cmover");
                if(array[filcam-1][col]=="nada"){
                    if(jaqueMate==false){
                        $("#c"+(filcam-1)+""+col).removeClass().addClass("cmover");
                    }else{
            ...
            if(filcam>0){
                for(var cont=filcam;cont>0 && salir==false;cont--){
                    if(array[cont][col]=="nada"){
                        if(jaqueMate==false){
                            $("#c"+cont+""+col).removeClass().addClass("cmover");
                        }else{
            ...
            if(colcam>0){
                for(var cont=colcam;cont>0 && salir==false;cont--){
                    if(array[fil][cont]=="nada"){
                        if(jaqueMate==false){
                            $("#c"+fil+""+cont).removeClass().addClass("cmover");
                        }else{
            ...
            if(colcam<9){
                ...
                if(filcam1>0){
                    if(array[filcam1][colcam]=="nada"){
                        if(jaqueMate==false){
                            $("#c"+filcam1+""+colcam).removeClass().addClass("cmover");
                        }else{
        ...
        if(ficha=="alfi"+letra){
            ...
            for(var cont=filcam;cont>0 && colcam<9 && salir==false;cont--){
                if(array[cont][colcam]=="nada"){
                        if(jaqueMate==false){
                            $("#c"+cont+""+colcam).removeClass().addClass("cmover");
                        }else{
        ...
        if(ficha=="rey_"+letra){
            ...
            if(colcam>0){
                if(array[fil][colcam]=="nada"){
                    if(jaqueMate==false){
                        $("#c"+fil+""+colcam).removeClass().addClass("cmover");
                    }else{
...
function restaurarAzul(){
    for(var fil=1;fil!=9;fil++){
        for(var col=1;col!=9;col++){
            var claseName= $("#c"+fil+""+col).attr("class");
            if(claseName=="cmover2"){
                if(fil%2==0){
                    if(col%2==0){
                        $("#c"+fil+""+col).removeClass().addClass("cblanco");
                    }else{
                        $("#c"+fil+""+col).removeClass().addClass("cnegro");
                    }
                }else{
                    if(col%2==0){
                        $("#c"+fil+""+col).removeClass().addClass("cnegro");
...
function colocador(ids,tmp){
    ...
    var fild=parseInt(tmp.charAt(1));
    var cold=parseInt(tmp.charAt(2));
    if($("#c"+fild+""+cold).attr("class")=="cmover" || $("#c"+fild+""+cold).attr("class")=="cmover1"){
        if($("#c"+fild+""+cold).attr("class")=="cmover"){
            reproSon("ficha.wav");
            var ultFichtemp = localStorage.getItem("ultmfich");
            var UltmFichTemp;
        ...
        if(movimiento=="si"){
            $("#c"+fils+""+cols).removeClass().addClass("cmover2");
            $("#c"+fild+""+cold).removeClass().addClass("cmover2");
        }
...
function peonComp(){
    for(var col=1;col<9;col++){
        if(array[1][col]=="peonb"){
            ...
            $("#ppbl").removeClass().addClass("");
            $("#elegirbl").removeClass().addClass("");
            $("#bb1").css("background-image", "url(../img/chess-icons/torre-b.svg)");
            $("#bb2").css("background-image", "url(../img/chess-icons/caballo-b.svg)");
            $("#bb3").css("background-image", "url(../img/chess-icons/alfil-b.svg)");
            $("#bb4").css("background-image", "url(../img/chess-icons/reina-b.svg)");
            for(var cont=1;cont!=5;cont++){
                $("#bb"+cont).on("click",convBlanco);
            }           
        }
        if(array[8][col]=="peonn"){
            localStorage.setItem("jugar","no");
            $("#ppn").removeClass().addClass("");
            $("#elegirn").removeClass().addClass("");
            $("#bn1").css("background-image", "url(../img/chess-icons/torre-n.svg)");
            $("#bn2").css("background-image", "url(../img/chess-icons/caballo-n.svg)");
            $("#bn3").css("background-image", "url(../img/chess-icons/alfil-n.svg)");
            $("#bn4").css("background-image", "url(../img/chess-icons/reina-n.svg)");
            for(var cont=1;cont!=5;cont++){
                $("#bn"+cont).on("click",convNegro);
            }
        }
    }
}
...
function jaqueMateComp(fichas,posiciones,fichasPosi,posicionesPosi,letraRey,posicionesFichasInter){
    ...
    if(comp==comp1 && ttjaque==true && mattt=="si"){
        ...
        $("#turno").html("Han ganado las fichas "+ganador);
    }
    ...
    if(color=="b"){
        ...
        if(tpp<=0 && tpp1==0){
            if(array[8][1]=="torrb"){
                ...
                if(acu==0){
                    $("#c83").removeClass().addClass("cmover1");
                }
            }
            acu=0;
            if(array[8][8]=="torrb"){
                ...
                if(acu==0){
                    $("#c87").removeClass().addClass("cmover1");
                }
            }
        }
    }
    if(color=="n"){
        ...
        if(tpp==0 && tpp1==0){
            if(array[1][1]=="torrn"){
                ...
                if(acu==0){
                    $("#c13").removeClass().addClass("cmover1");
                }
            }
            acu=0;
            if(array[1][8]=="torrn"){
                ...
                if(acu==0){
                    $("#c17").removeClass().addClass("cmover1");
                }
            }
        }
    }
...
function convNegro(ev){
    turnos();
    $("#ppn").removeClass().addClass("inv");
    $("#elegirn").removeClass().addClass("inv");
    var id = ev.target.id;
...
function convBlanco(ev){
    turnos();
    $("#ppbl").removeClass().addClass("inv");
    $("#elegirbl").removeClass().addClass("inv");
    var id = ev.target.id;
    var num = parseInt(id.charAt(2));
    var fich;
    var nomficha;
...
function cargarSave(){
    ...
    for(var cont=1;cont<321;cont++){
        ...
        if(acu==5 && temp!="nada_"){
            ...
            var modo=localStorage.getItem("modo");
            if(modo=="tocar"){
                dd.on("click",colotoc,false);
                dd.on("click",colotoc2,false);
            }else{
                dd.on("dragstart",arrastrar,false);
            }
            dd.attr("id","d"+fil+""+col);
            $("#c"+fil+""+col).append(dd);
        }else{
            array[fil][col]="nada"
        }
        ...
        if(fichListaB!=""){
            ...
            for(var cont=0;cont<fichListaB.length;cont++){
                ...
                if(acu==5){
                    ...
                    dd.attr("id","ddd"+letra+""+pos);
                    if(pos<=8 && letra=="bl"){
                        $("#col"+letra1+"1").append(dd);
                    }else{
                        if(letra=="bl"){
                            $("#col"+letra1).append(dd);
                        }
                    }
                    if(pos<=8 && letra=="n"){
                        $("#col"+letra1).append(dd);
